  ...
  IF PARSENAME(@version, 3) + PARSENAME(@version, 2)  <> PARSENAME('2.0.20230414154603', 3) + PARSENAME('2.0.20230414154603', 2)
  BEGIN
  RAISERROR ('The Target was at version %s, not the correct version (2.0.20230414154603)',16,1,@version)
  SET NOEXEC ON;
  END
--flybot created V3.0.0__366-SCH-001-schema-v2.0.20230414154603
-- DEBUG ---
