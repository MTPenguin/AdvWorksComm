  ...
  SET NOEXEC ON;
  END
--flybot created V2.0.20230414144928__360-BAS-001-data-v2.0.20230328210325
-- DEBUG ---
PRINT(N'Update 6 rows in [SalesLT].[Customer]')
      UPDATE [SalesLT].[Customer] SET [Suffix]='041414' WHERE [CustomerID] = 1
      UPDATE [SalesLT].[Customer] SET [Suffix]='041414' WHERE [CustomerID] = 2
      UPDATE [SalesLT].[Customer] SET [Suffix]='041414' WHERE [CustomerID] = 3
      UPDATE [SalesLT].[Customer] SET [Suffix]='041414' WHERE [CustomerID] = 4
      UPDATE [SalesLT].[Customer] SET [Suffix]='041414' WHERE [CustomerID] = 5
      UPDATE [SalesLT].[Customer] SET [Suffix]='041414' WHERE [CustomerID] = 6
    -- DEBUG ---
  ...
  SET @version=N'2.0.20230414144928'
