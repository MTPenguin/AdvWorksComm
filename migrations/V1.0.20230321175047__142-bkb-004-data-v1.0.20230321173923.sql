  ...
  IF PARSENAME(@version, 2) + PARSENAME(@version, 3)  <> PARSENAME('1.0.20230321173923', 2) + PARSENAME('1.0.20230321173923', 3)
  BEGIN
  RAISERROR ('The Target was at version %s, not the correct version (1.0.20230321173923)',16,1,@version)
  SET NOEXEC ON;
  END
--flybot created V1.0.20230321175047__142-bkb-004-data-v1.0.20230321173923
-- DEBUG ---
PRINT(N'Update 6 rows in [SalesLT].[Customer]')
      UPDATE [SalesLT].[Customer] SET [Suffix]='032117' WHERE [CustomerID] = 1
      UPDATE [SalesLT].[Customer] SET [Suffix]='032117' WHERE [CustomerID] = 2
      UPDATE [SalesLT].[Customer] SET [Suffix]='032117' WHERE [CustomerID] = 3
      UPDATE [SalesLT].[Customer] SET [Suffix]='032117' WHERE [CustomerID] = 4
      UPDATE [SalesLT].[Customer] SET [Suffix]='032117' WHERE [CustomerID] = 5
      UPDATE [SalesLT].[Customer] SET [Suffix]='032117' WHERE [CustomerID] = 6
    -- DEBUG ---
  ...
  SET @version=N'1.0.20230321175047'
